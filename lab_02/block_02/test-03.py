## TWO NUMBERS, ALL OPERATIONS (2) ##

print("\n")
print("## TWO NUMBERS, ALL OPERATIONS (2)##")

print("Previously we showed the operations in columns, now we are going to divide it into rows...\n")
